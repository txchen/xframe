...
ffmpeg -hide_banner -loglevel error -i .build/fixtures/h264-1080p60.mp4 \
  -c:v copy -an -bsf:v 'h264_mp4toannexb,h264_metadata=aud=insert' \
  -f h264 -y .build/fixtures/h264-1080p60.h264
