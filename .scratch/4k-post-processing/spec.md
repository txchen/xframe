...
1. Spatial upscaling and restrained sharpening: native MetalFX Spatial first, ordinary scaling bypass for comparison; evaluate FSR 1 EASU/RCAS port to Metal as an alternate backend. Preserve color/range, aspect ratio, readable UI and resizing. 1080p-to-2160p is the initial case; no claim to recover all missing native-4K detail.
