...
- Live single-controller integration is implemented behind View > Enable Controller Input; Palworld controls and focus-loss release have passed user-observed physical acceptance. Rumble is implemented for the shared cloud/console input path; physical vibration testing remains.
