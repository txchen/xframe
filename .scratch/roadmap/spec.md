...
- Current implementation passes 141 tests; the latest signed-build evidence is recorded in [playback settings validation](../playback-settings/validation.md). Individual feature documents record remaining live-validation limits.
